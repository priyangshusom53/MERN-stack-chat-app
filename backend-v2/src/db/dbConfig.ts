...
export const getMongoDBConnection = (): mongoose.Connection | null => {
   return mongoose.connection;
};

export const createMongoDBModel = (name: string, schema: mongoose.Schema, collectionName: string): mongoose.Model<any> => {
